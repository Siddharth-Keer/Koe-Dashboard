...
import { User, Mail, Lock, ArrowLeft, CheckCircle, XCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-8">User Profile</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Your profile details</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-base font-medium text-gray-800 dark:text-white">{userEmail || 'Not set'}</p>
                </div>
              </div>
            </div>
          </div>
